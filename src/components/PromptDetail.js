...
const PromptDetail = () => {
  ...
  const handleGetPromptClick = () => {
    const cartItems = [{ promptId: prompt, quantity: 1 }];  // Example item structure for checkout
    const totalPrice = prompt.price;  // Assuming prompt price as total for single item
