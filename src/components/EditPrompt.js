...
export const CreatePrompt = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:5000/api/v1/createPrompt', formData, {
      headers: {
      ...
      axios.post('http://localhost:5000/api/v1/addActivity',{username:promptData.username,activity:"Created a prompt",date:Date.now()})
        // Send approval request after prompt creation
        return axios.post('http://localhost:5000/api/v1/admin/approvePrompt', { username: promptData.username });
      })
      .then(result => {
        alert("Prompt sent for approval");
        axios.post('http://localhost:5000/api/v1/addActivity',{username:promptData.username,activity:"Prompt Sent for approval",date:Date.now()})
      })
      .catch(err => {
...
export const EditPrompt = () => {
  ...
  useEffect(()=>{
    axios.get(`http://localhost:5000/api/v1/user/${username}/prompts`)
      .then(response => {
...
export const DeletePrompt = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:5000/api/v1/user/${username}/deleted-prompts`)
      .then(response => {
  ...
  const handleDeletePrompt = (promptId) => {
    axios.delete(`http://localhost:5000/api/v1/prompt/${promptId}/delete`)
      .then(response => {
        ...
        axios.post('http://localhost:5000/api/v1/addActivity',{username:username,activity:"Deleted a prompt",date:Date.now()})
      })
      .catch(error => {
  ...
  const handleUndoDelete = (promptId) => {
    axios.put(`http://localhost:5000/api/v1/prompt/${promptId}/restore`)
      .then(response => {
        ...
        axios.post('http://localhost:5000/api/v1/addActivity',{username:username,activity:"Restored a prompt"})
      })
      .catch(error => {
  ...
  const handlePermanentDelete = (promptId) => {
    axios.delete(`http://localhost:5000/api/v1/prompt/${promptId}/permanently`)
      .then(response => {
        setDeletedPrompts(deletedPrompts.filter(prompt => prompt._id !== promptId));
        alert('Prompt permanently deleted');
        axios.post('http://localhost:5000/api/v1/addActivity',{username,activity:"Deleted a prompt"},date)
      })
      .catch(error => {
...
export const BuyPrompt = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/v1/getPrompt')
      .then(result => {
