...
const UserProfile = () => {
  ...
  useEffect(() => {
    // Fetch user data
    axios.get(`http://localhost:5000/api/v1/user/${username}`)
      .then(response => {
    ...
    axios.get(`http://localhost:5000/api/v1/${username}/getOrders`)
      .then(response => {
        ...
        axios.get(`http://localhost:5000/api/v1/getPrompts`)
      .then(response => {
  ...
  const handleSaveClick = () => {
    axios.post(`http://localhost:5000/api/v1/user/${username}/update`, editedData)
      .then(() => {
